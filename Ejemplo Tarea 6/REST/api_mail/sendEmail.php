...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'isaproftec@gmail.com'; // Tu correo
    $mail->Password   = 'hvpl eosl avee nzib'; // Contraseña o clave de aplicación
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;

    // Configuración del correo
    $mail->setFrom('isaproftec@gmail.com', 'Isabel');
